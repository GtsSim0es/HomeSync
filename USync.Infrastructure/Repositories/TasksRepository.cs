...
public class TasksRepository(ApplicationDbContext context) : ITasksRepository
{
    ...
    public async Task<UserTask> GetTask(long taskId) => await _context.UserTasks.FirstOrDefaultAsync(x => x.Id == taskId) ?? new UserTask(String.Empty, String.Empty, DateTime.MinValue);
